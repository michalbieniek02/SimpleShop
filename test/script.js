document.addEventListener('DOMContentLoaded', function () {
    const aboutPageFirstSpan = 'All crops are collected by hard working children in Africa'
    const aboutPageSecondSpan = 'Our soil is a specialized mix designed by the best gardeners in the whole world'
    const aboutPageThirdSpan = 'All our packages are hermetically packed so there is no smell coming outta it so u can illegally smuggle it to ur country! :))'

    const pages = [
        { name: 'Products', content: [] },
        { name: 'About Us', content: 
            printAboutUsPageContent(
    ...
    function printAboutUsPageContent(firstImageSrc,secondImageSrc,thirdImageSrc,firstSpan,secondSpan,thirdSpan){
        const hardCodedSite = `<div class="about-content">
        <div class="row"><img src =${firstImageSrc} alt="Excample gardening photo" class="img"></img>
        <h3>${firstSpan}</h3></div>
        <div class="row"><img src =${secondImageSrc} alt="Excample gardening photo" class="img"></img>
        <h3>${secondSpan}</h3></div>
        <div class="row"> <img src =${thirdImageSrc} alt="Excample gardening photo" class="img"></img>
        <h3>${thirdSpan}</h3></div>
    </div>`
    ...
    function printForm(){
        const hardCodedSite = `<div class="modal">
        <form class="form">
        ...
        <rect fill="white" height="38.1" width="80"></rect>
          ...
          <div class="credit-card-info--form">
            ...
            <button id='purchase' class="purchase--btn">Checkout</button>
        </form>
        </div>`
